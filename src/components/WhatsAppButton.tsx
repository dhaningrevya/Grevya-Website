...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <a
      ...
      data-cursor="hover"
      className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-30 group inline-flex items-center gap-2.5 p-3 sm:p-3.5 rounded-full bg-[#131313]/90 hover:bg-[#1a1a1a] backdrop-blur-xl border border-white/10 hover:border-[#25D366]/50 text-white shadow-2xl transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366]"
    >
      {/* Live Active Green Indicator Dot */}
      ...
      <svg
        viewBox="0 0 32 32"
        className="h-5 w-5 fill-[#25D366] transition-transform duration-300 group-hover:scale-110"
        aria-hidden="true"
      >
      ...
      {/* Expandable Text Label (Desktop Hover) */}
      <span className="hidden md:group-hover:inline-flex items-center gap-1 font-sans text-xs font-semibold uppercase tracking-[0.15em] text-white whitespace-nowrap overflow-hidden transition-all duration-300">
